...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    {   
        ...
        if(MethodExtend.readFromButton == 1 && activeMiniGame == false)
        {
           ...
           //////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            paintWordPositionWriteTextField_size22(700, 920, "PRESS CONTROL KEY TO MENU");
            paintWordPositionWriteTextField_size22(700, 970, "PRESS CONTROL KEY TO MENU");
        ...
        if(Input.GetKeyUp(KeyCode.F2))
        {
            ...
            ScriptCommunication.wordsToPaint = 1;
        ...
        if(Input.GetKeyUp(KeyCode.F3))
        {
            ...
            ScriptCommunication.wordsToPaint = 2;
            ScriptCommunication.activateWordToPaint = true;
            ScriptCommunication.endOfMiniGame = false;
            object_PlaneWrite.SetActive(false);
        ...
        if(Input.GetKeyUp(KeyCode.Return))
        {
            ...
            if(wordCheck0 == false)                        
            {
                ...
                {   
                    ...
                    ZeroOrOne = (ZeroOrOne == 0)? (byte) 1 : (byte) 0;
        ...
        if(Input.GetKeyUp(KeyCode.F4))
    {
        ...
        if(activeKeaboard == true && StringTextField.Length <= 30 && ScriptCommunication.enableKeyboard == true)
        {
        ...
        if(activeKeaboard == true && Input.GetKeyUp(KeyCode.Backspace) && StringTextField.Length > 0)
        {
            ...
            paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,2,6);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void firstCheck()
    {
        ...
        string operation_ScriptCommunication_StringTextField = ScriptCommunication.tuplaWords[ZeroOrOne];
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void paintAlphabetFromTextureWriteTextField_size22()
    {
    ...
    public void paintAlphabetFromTextureIndividualWriteTextField_size22(int Xaxis, int Yaxis, int Xtile, int Ytile)
    {
    ...
    public void paintNumberFromTextureIndividualWriteTextField_size22(int Xaxis, int Yaxis, int Xtile, int Ytile)
    {
    ...
    public void paintPortugueseFromTextureIndividualWriteTextField_size22(int Xaxis, int Yaxis, int Xtile, int Ytile)
    {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void paintWordPositionWriteTextField(int Xaxis, int Yaxis, string manageString)
    {
        ...
        for(int i = 0; i < inputString.Length; ++i) 
        {
            ...
            if(characterToPaint == "A")
            {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 0, 0);
                _PositionTranslateX -= CHARACTERWIDTH;
            }

            if(characterToPaint == "B")
            {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 1, 0);
                _PositionTranslateX -= CHARACTERWIDTH;
            }

            if(characterToPaint == "C")
            {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 2, 0);
                _PositionTranslateX -= CHARACTERWIDTH;
            }

            if(characterToPaint == "D")
            {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 3, 0);
                _PositionTranslateX -= CHARACTERWIDTH;
            }

            if(characterToPaint == "E")
            {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 0, 1);
                _PositionTranslateX -= CHARACTERWIDTH;
            }

            if(characterToPaint == "F")
            {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 1, 1);
                _PositionTranslateX -= CHARACTERWIDTH;
            }

            if(characterToPaint == "G")
            {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 2, 1);
                _PositionTranslateX -= CHARACTERWIDTH;
            }

            if(characterToPaint == "H")
            {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 3, 1);
                _PositionTranslateX -= CHARACTERWIDTH;
            }

            if(characterToPaint == "I")
            {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 0, 2);
                _PositionTranslateX -= CHARACTERWIDTH;
            }

            if(characterToPaint == "J")
            {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 1, 2);
                _PositionTranslateX -= CHARACTERWIDTH;
            }

            if(characterToPaint == "K")
            {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 2, 2);
                _PositionTranslateX -= CHARACTERWIDTH;
            }

            if(characterToPaint == "L")
            {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 3, 2);
                _PositionTranslateX -= CHARACTERWIDTH;
            }

            if(characterToPaint == "M")
            {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 0, 3);
                _PositionTranslateX -= CHARACTERWIDTH;
            }

            if(characterToPaint == "N")
            {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 1, 3);
                _PositionTranslateX -= CHARACTERWIDTH;
            }

            if(characterToPaint == "O")
            {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 2, 3);
                _PositionTranslateX -= CHARACTERWIDTH;
            }

            if(characterToPaint == "P")
            {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 3, 3);
                _PositionTranslateX -= CHARACTERWIDTH;
            }

            if(characterToPaint == "Q")
            {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 0, 4);
                _PositionTranslateX -= CHARACTERWIDTH;
            }

            if(characterToPaint == "R")
            {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 1, 4);
                _PositionTranslateX -= CHARACTERWIDTH;
            }

            if(characterToPaint == "S")
            {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 2, 4);
                _PositionTranslateX -= CHARACTERWIDTH;
            }

            if(characterToPaint == "T")
            {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 3, 4);
                _PositionTranslateX -= CHARACTERWIDTH;
            }

            if(characterToPaint == "U")
                {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 0, 5);
                _PositionTranslateX -= CHARACTERWIDTH;
            }

            if(characterToPaint == "V")
            {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 1, 5);
                _PositionTranslateX -= CHARACTERWIDTH;
            }

            if(characterToPaint == "W")
            {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 2, 5);
                _PositionTranslateX -= CHARACTERWIDTH;
            }

            if(characterToPaint == "X")
            {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 3, 5);
                _PositionTranslateX -= CHARACTERWIDTH;
            }

            if(characterToPaint == "Y")
            {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 0, 6);
                _PositionTranslateX -= CHARACTERWIDTH;
            }

            if(characterToPaint == "Z")
            {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 1, 6);
                _PositionTranslateX -= CHARACTERWIDTH;
            }

            if(characterToPaint == " ")
            {
                paintAlphabetFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 2, 6);
                _PositionTranslateX -= CHARACTERWIDTH;
            }
            ...
            if(MethodExtend.keyboardLanguage == 0)
            {
                ...
                if(characterToPaint == "0")
                {
                    paintNumberFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 0, 0);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
    
                if(characterToPaint == "1")
                {
                    paintNumberFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 1, 0);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
    
                if(characterToPaint == "2")
                {
                    paintNumberFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 2, 0);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
    
                if(characterToPaint == "3")
                {
                    paintNumberFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 3, 0);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
    
                if(characterToPaint == "4")
                {
                    paintNumberFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 0, 1);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
    
                if(characterToPaint == "5")
                {
                    paintNumberFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 1, 1);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
    
                if(characterToPaint == "6")
                {
                    paintNumberFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 2, 1);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
    
                if(characterToPaint == "7")
                {
                    paintNumberFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 3, 1);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
    
                if(characterToPaint == "8")
                {
                    paintNumberFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 0, 2);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
    
                if(characterToPaint == "9")
                {
                    paintNumberFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 1, 2);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
    
                if(characterToPaint == "À")
                {
                    paintNumberFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 2, 2);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
    
                if(characterToPaint == "È")
                {
                    paintNumberFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 3, 2);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
    
                if(characterToPaint == "É")
                {
                    paintNumberFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 0, 3);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
    
                if(characterToPaint == "Ì")
                {
                    paintNumberFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 1, 3);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
    
                if(characterToPaint == "Ò")
                {
                    paintNumberFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 2, 3);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
    
                if(characterToPaint == "Ù")
                {
                    paintNumberFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 3, 3);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
    
                if(characterToPaint == "’")
                {
                    paintNumberFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 0, 4);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
                if(characterToPaint == "‘")
                {
                    paintNumberFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 1, 4);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
            ...
            if(MethodExtend.keyboardLanguage == 1)
            {
                ...
                if(characterToPaint == "Á")
                {
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 0, 0);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
            
                if(characterToPaint == "À")
                {
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 1, 0);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
            
                if(characterToPaint == "Â")
                {
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 2, 0);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }

                if(characterToPaint == "Ã")
                {
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 0, 1);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
            
                if(characterToPaint == "Ä")
                {
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 3, 0);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
            
                if(characterToPaint == "Ç")
                {
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 1, 1);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
    
                if(characterToPaint == "É")
                {
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 2, 1);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
            
                if(characterToPaint == "È")
                {
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 3, 1);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
            
                if(characterToPaint == "Ê")
                {
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 0, 2);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }

                if(characterToPaint == "Ë")
                {
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 1, 2);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }    

                if(characterToPaint == "Í")
                {
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 2, 2);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
            
                if(characterToPaint == "Ì")
                {
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 3, 2);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
            
                if(characterToPaint == "Î")
                {
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 0, 3);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }

                if(characterToPaint == "Ï")
                {
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 1, 3);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }    

                if(characterToPaint == "Ó")
                {
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 2, 3);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
            
                if(characterToPaint == "Ò")
                {
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 3, 3);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
        
                if(characterToPaint == "Õ")
                {
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 2, 4);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }

                if(characterToPaint == "Ô")
                {
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 0, 4);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }    

                if(characterToPaint == "Ö")
                {
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 1, 4);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }    
                ...
                if(characterToPaint == "Ù")
                {
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 0, 5);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }
            
                if(characterToPaint == "Û")
                {
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 1, 5);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }

                if(characterToPaint == "Ü")
                {
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionTranslateX, _PositionTranslateY, 2, 5);
                    _PositionTranslateX -= CHARACTERWIDTH;
                }    
    ...
    public void paintWordPositionWriteTextField_size22(int Xaxis, int Yaxis, string manageString)
    {
        ...
        for(int i = 0; i < inputString.Length; ++i) 
        {
            ...
            if(characterToPaint == "A")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 0, 0);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }

            if(characterToPaint == "B")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 1, 0);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }

            if(characterToPaint == "C")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 2, 0);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }

            if(characterToPaint == "D")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 3, 0);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }

            if(characterToPaint == "E")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 0, 1);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }

            if(characterToPaint == "F")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 1, 1);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }

            if(characterToPaint == "G")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 2, 1);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }

            if(characterToPaint == "H")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 3, 1);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }

            if(characterToPaint == "I")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 0, 2);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }

            if(characterToPaint == "J")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 1, 2);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }

            if(characterToPaint == "K")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 2, 2);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }

            if(characterToPaint == "L")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 3, 2);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }

            if(characterToPaint == "M")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 0, 3);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }

            if(characterToPaint == "N")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 1, 3);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }

            if(characterToPaint == "O")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 2, 3);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }

            if(characterToPaint == "P")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 3, 3);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }

            if(characterToPaint == "Q")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 0, 4);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }

            if(characterToPaint == "R")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 1, 4);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }

            if(characterToPaint == "S")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 2, 4);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }

            if(characterToPaint == "T")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 3, 4);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }

            if(characterToPaint == "U")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 0, 5);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }

            if(characterToPaint == "V")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 1, 5);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }

            if(characterToPaint == "W")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 2, 5);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }

            if(characterToPaint == "X")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 3, 5);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }

            if(characterToPaint == "Y")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 0, 6);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }

            if(characterToPaint == "Z")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 1, 6);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }

            if(characterToPaint == " ")
            {
                paintAlphabetFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 2, 6);
                _PositionTranslateX -= CHARACTERWIDTH_size22;
            }
            ...
            if(MethodExtend.keyboardLanguage == 0)
            {
                ...
                if(characterToPaint == "0")
                {
                    paintNumberFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 0, 0);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
    
                if(characterToPaint == "1")
                {
                    paintNumberFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 1, 0);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
    
                if(characterToPaint == "2")
                {
                    paintNumberFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 2, 0);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
    
                if(characterToPaint == "3")
                {
                    paintNumberFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 3, 0);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
    
                if(characterToPaint == "4")
                {
                    paintNumberFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 0, 1);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
    
                if(characterToPaint == "5")
                {
                    paintNumberFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 1, 1);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
    
                if(characterToPaint == "6")
                {
                    paintNumberFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 2, 1);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
    
                if(characterToPaint == "7")
                {
                    paintNumberFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 3, 1);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
    
                if(characterToPaint == "8")
                {
                    paintNumberFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 0, 2);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
    
                if(characterToPaint == "9")
                {
                    paintNumberFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 1, 2);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
    
                if(characterToPaint == "À")
                {
                    paintNumberFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 2, 2);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
    
                if(characterToPaint == "È")
                {
                    paintNumberFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 3, 2);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
    
                if(characterToPaint == "É")
                {
                    paintNumberFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 0, 3);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
    
                if(characterToPaint == "Ì")
                {
                    paintNumberFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 1, 3);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
    
                if(characterToPaint == "Ò")
                {
                    paintNumberFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 2, 3);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
    
                if(characterToPaint == "Ù")
                {
                    paintNumberFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 3, 3);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
    
                if(characterToPaint == "’")
                {
                    paintNumberFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 0, 4);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }

                if(characterToPaint == "‘")
                {
                    paintNumberFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 1, 4);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }

                if(characterToPaint == "?")
                {
                    paintNumberFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 2, 4);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }

                if(characterToPaint == "!")
                {
                    paintNumberFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 3, 4);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }

                if(characterToPaint == ",")
                {
                    paintNumberFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 0, 5);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }

                if(characterToPaint == ".")
                {
                    paintNumberFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 1, 5);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }

                if(characterToPaint == ":")
                {
                    paintNumberFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 2, 5);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }

                if(characterToPaint == ";")
                {
                    paintNumberFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 3, 5);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
            ...
            if(MethodExtend.keyboardLanguage == 1)
            {
                ...
                if(characterToPaint == "Á")
                {
                    paintPortugueseFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 0, 0);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
            
                if(characterToPaint == "À")
                {
                    paintPortugueseFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 1, 0);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
            
                if(characterToPaint == "Â")
                {
                    paintPortugueseFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 2, 0);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }

                if(characterToPaint == "Ã")
                {
                    paintPortugueseFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 0, 1);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
            
                if(characterToPaint == "Ä")
                {
                    paintPortugueseFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 3, 0);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
            
                if(characterToPaint == "Ç")
                {
                    paintPortugueseFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 1, 1);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
    
                if(characterToPaint == "É")
                {
                    paintPortugueseFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 2, 1);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
            
                if(characterToPaint == "È")
                {
                    paintPortugueseFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 3, 1);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
            
                if(characterToPaint == "Ê")
                {
                    paintPortugueseFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 0, 2);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }

                if(characterToPaint == "Ë")
                {
                    paintPortugueseFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 1, 2);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }    

                if(characterToPaint == "Í")
                {
                    paintPortugueseFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 2, 2);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
            
                if(characterToPaint == "Ì")
                {
                    paintPortugueseFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 3, 2);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
            
                if(characterToPaint == "Î")
                {
                    paintPortugueseFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 0, 3);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }

                if(characterToPaint == "Ï")
                {
                    paintPortugueseFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 1, 3);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }    

                if(characterToPaint == "Ó")
                {
                    paintPortugueseFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 2, 3);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
            
                if(characterToPaint == "Ò")
                {
                    paintPortugueseFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 3, 3);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
        
                if(characterToPaint == "Õ")
                {
                    paintPortugueseFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 2, 4);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }

                if(characterToPaint == "Ô")
                {
                    paintPortugueseFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 0, 4);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }    

                if(characterToPaint == "Ö")
                {
                    paintPortugueseFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 1, 4);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }    
                ...
                if(characterToPaint == "Ù")
                {
                    paintPortugueseFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 0, 5);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }
            
                if(characterToPaint == "Û")
                {
                    paintPortugueseFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 1, 5);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }

                if(characterToPaint == "Ü")
                {
                    paintPortugueseFromTextureIndividualWriteTextField_size22(_PositionTranslateX, _PositionTranslateY, 2, 5);
                    _PositionTranslateX -= CHARACTERWIDTH_size22;
                }    
        ...
        //////////////////////////////////////////////////////////////////////////
            ...
            if(MethodExtend.keyboardLanguage == 1)
            {
                ...
                if(Input.GetKeyUp(KeyCode.A) && appostrophe == 1 )
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionX, _PositionY, 0, 0);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.A) && appostrophe == 2)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionX, _PositionY, 1, 0);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.A) && appostrophe == 4)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionX, _PositionY, 2, 0);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.A) && appostrophe == 3)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionX, _PositionY, 0, 1);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.A) && appostrophe == 5)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionX, _PositionY, 3, 0);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.Semicolon))
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionX, _PositionY, 1, 1);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.E) && appostrophe == 1 )
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionX, _PositionY, 2, 1);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.E) && appostrophe == 2)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionX, _PositionY, 3, 1);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.E) && appostrophe == 4)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionX, _PositionY, 0, 2);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.E) && appostrophe == 5)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionX, _PositionY, 1, 2);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.I) && appostrophe == 1 )
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionX, _PositionY, 2, 2);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.I) && appostrophe == 2)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionX, _PositionY, 3, 2);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.I) && appostrophe == 4)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionX, _PositionY, 0, 3);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.I) && appostrophe == 5)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionX, _PositionY, 1, 3);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.O) && appostrophe == 1 )
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionX, _PositionY, 2, 3);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.O) && appostrophe == 2)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionX, _PositionY, 3, 3);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.O) && appostrophe == 4)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionX, _PositionY, 2, 4);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.O) && appostrophe == 3)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionX, _PositionY, 0, 4);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.O) && appostrophe == 5)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionX, _PositionY, 1, 4);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.U) && appostrophe == 2)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionX, _PositionY, 0, 5);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.U) && appostrophe == 4)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionX, _PositionY, 1, 5);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.U) && appostrophe == 5)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintPortugueseFromTextureIndividualWriteTextField(_PositionX, _PositionY, 2, 5);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
            ...
            if(Input.GetKeyUp(KeyCode.A) && appostrophe == 0)
            {
                ...
                // Paint letter
                ///////////////////////////////////        
                paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,0,0);
                ///////////////////////////////////
                // Paint letter
                ///////////////////////////////////
            ...
            if(Input.GetKeyUp(KeyCode.B))
            {
                ...
                // Paint letter
                ///////////////////////////////////        
                paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,1,0);
                ///////////////////////////////////
                // Paint letter
                ///////////////////////////////////
            ...
            if(Input.GetKeyUp(KeyCode.C))
            {
                ...
                // Paint letter
                ///////////////////////////////////        
                paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,2,0);
                ///////////////////////////////////
                // Paint letter
                ///////////////////////////////////
            ...
            if(Input.GetKeyUp(KeyCode.D))
            {
                ...
                // Paint letter
                ///////////////////////////////////        
                paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,3,0);
                ///////////////////////////////////
                // Paint letter
                ///////////////////////////////////
            ...
            if(Input.GetKeyUp(KeyCode.E) && appostrophe == 0)
            {
                ...
                // Paint letter
                ///////////////////////////////////        
                paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,0,1);
                ///////////////////////////////////
                // Paint letter
                ///////////////////////////////////
            ...
            if(Input.GetKeyUp(KeyCode.F))
            {
                ...
                // Paint letter
                ///////////////////////////////////        
                paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,1,1);
                ///////////////////////////////////
                // Paint letter
                ///////////////////////////////////
            ...
            if(Input.GetKeyUp(KeyCode.G))
            {
                ...
                // Paint letter
                ///////////////////////////////////        
                paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,2,1);
                ///////////////////////////////////
                // Paint letter
                ///////////////////////////////////
            ...
            if(Input.GetKeyUp(KeyCode.H))
            {
                ...
                // Paint letter
                ///////////////////////////////////        
                paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,3,1);
                ///////////////////////////////////
                // Paint letter
                ///////////////////////////////////
            ...
            if(Input.GetKeyUp(KeyCode.I) && appostrophe == 0)
            {
                ...
                // Paint letter
                ///////////////////////////////////        
                paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,0,2);
                ///////////////////////////////////
                // Paint letter
                ///////////////////////////////////
            ...
            if(Input.GetKeyUp(KeyCode.J))
            {
                ...
                // Paint letter
                ///////////////////////////////////        
                paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,1,2);
                ///////////////////////////////////
                // Paint letter
                ///////////////////////////////////
            ...
            if(Input.GetKeyUp(KeyCode.K))
            {
                ...
                // Paint letter
                ///////////////////////////////////        
                paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,2,2);
                ///////////////////////////////////
                // Paint letter
                ///////////////////////////////////
            ...
            if(Input.GetKeyUp(KeyCode.L))
            {
                ...
                // Paint letter
                ///////////////////////////////////        
                paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,3,2);
                ///////////////////////////////////
                // Paint letter
                ///////////////////////////////////
            ...
            if(Input.GetKeyUp(KeyCode.M))
            {
                ...
                // Paint letter
                ///////////////////////////////////        
                paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,0,3);
                ///////////////////////////////////
                // Paint letter
                ///////////////////////////////////
            ...
            if(Input.GetKeyUp(KeyCode.N))
            {
                ...
                // Paint letter
                ///////////////////////////////////        
                paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,1,3);
                ///////////////////////////////////
                // Paint letter
                ///////////////////////////////////
            ...
            if(Input.GetKeyUp(KeyCode.O) && appostrophe == 0)
            {
                ...
                // Paint letter
                ///////////////////////////////////        
                paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,2,3);
                ///////////////////////////////////
                // Paint letter
                ///////////////////////////////////
            ...
            if(Input.GetKeyUp(KeyCode.P))
            {
                ...
                // Paint letter
                ///////////////////////////////////        
                paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,3,3);
                ///////////////////////////////////
                // Paint letter
                ///////////////////////////////////
            ...
            if(Input.GetKeyUp(KeyCode.Q))
            {
                ...
                // Paint letter
                ///////////////////////////////////        
                paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,0,4);
                ///////////////////////////////////
                // Paint letter
                ///////////////////////////////////
            ...
            if(Input.GetKeyUp(KeyCode.R))
            {
                ...
                // Paint letter
                ///////////////////////////////////        
                paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,1,4);
                ///////////////////////////////////
                // Paint letter
                ///////////////////////////////////
            ...
            if(Input.GetKeyUp(KeyCode.S))
            {
                ...
                // Paint letter
                ///////////////////////////////////        
                paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,2,4);
                ///////////////////////////////////
                // Paint letter
                ///////////////////////////////////
            ...
            if(Input.GetKeyUp(KeyCode.T))
            {
                ...
                // Paint letter
                ///////////////////////////////////        
                paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,3,4);
                ///////////////////////////////////
                // Paint letter
                ///////////////////////////////////
            ...
            if(Input.GetKeyUp(KeyCode.U))
            {
                ...
                // Paint letter
                ///////////////////////////////////        
                paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,0,5);
                ///////////////////////////////////
                // Paint letter
                ///////////////////////////////////
            ...
            if(Input.GetKeyUp(KeyCode.V))
            {
                ...
                // Paint letter
                ///////////////////////////////////        
                paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,1,5);
                ///////////////////////////////////
                // Paint letter
                ///////////////////////////////////
            ...
            if(Input.GetKeyUp(KeyCode.W))
            {
                ...
                // Paint letter
                ///////////////////////////////////        
                paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,2,5);
                ///////////////////////////////////
                // Paint letter
                ///////////////////////////////////
            ...
            if(Input.GetKeyUp(KeyCode.X))
            {
                ...
                // Paint letter
                ///////////////////////////////////        
                paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,3,5);
                ///////////////////////////////////
                // Paint letter
                ///////////////////////////////////
            ...
            if(Input.GetKeyUp(KeyCode.Y))
            {
                ...
                // Paint letter
                ///////////////////////////////////        
                paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,0,6);
                ///////////////////////////////////
                // Paint letter
                ///////////////////////////////////
            ...
            if(Input.GetKeyUp(KeyCode.Z))
            {
                ...
                // Paint letter
                ///////////////////////////////////        
                paintAlphabetFromTextureIndividualWriteTextField(_PositionX, _PositionY,1,6);
                ///////////////////////////////////
                // Paint letter
                ///////////////////////////////////
            ...
            if(MethodExtend.keyboardLanguage == 0)
            {
                ...
                if(Input.GetKeyUp(KeyCode.Alpha1) && shiftKey == false)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintNumberFromTextureIndividualWriteTextField(_PositionX, _PositionY,1,0);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.Quote))
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintNumberFromTextureIndividualWriteTextField(_PositionX, _PositionY, 2, 2);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.LeftBracket) && shiftKey == false)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintNumberFromTextureIndividualWriteTextField(_PositionX, _PositionY, 3, 2);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.LeftBracket) && shiftKey == true)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintNumberFromTextureIndividualWriteTextField(_PositionX, _PositionY, 0, 3);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.RightBracket))
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintNumberFromTextureIndividualWriteTextField(_PositionX, _PositionY, 1, 3);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.Semicolon))
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintNumberFromTextureIndividualWriteTextField(_PositionX, _PositionY, 2, 3);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.Backslash))
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintNumberFromTextureIndividualWriteTextField(_PositionX, _PositionY, 3, 3);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.Minus) && shiftKey == false )
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintNumberFromTextureIndividualWriteTextField(_PositionX, _PositionY, 0, 4);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.Minus) && shiftKey == true)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintNumberFromTextureIndividualWriteTextField(_PositionX, _PositionY, 1, 4);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.Slash) && shiftKey == true)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintNumberFromTextureIndividualWriteTextField(_PositionX, _PositionY, 2, 4);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.Alpha1) && shiftKey == true)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintNumberFromTextureIndividualWriteTextField(_PositionX, _PositionY, 3, 4);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.Comma) && shiftKey == false)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintNumberFromTextureIndividualWriteTextField(_PositionX, _PositionY, 0, 5);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.Period) && shiftKey == false)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintNumberFromTextureIndividualWriteTextField(_PositionX, _PositionY, 1, 5);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.Period) && shiftKey == true)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintNumberFromTextureIndividualWriteTextField(_PositionX, _PositionY, 2, 5);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
                ...
                if(Input.GetKeyUp(KeyCode.Comma) && shiftKey == true)
                {
                    ...
                    // Paint letter
                    ///////////////////////////////////        
                    paintNumberFromTextureIndividualWriteTextField(_PositionX, _PositionY, 3, 5);
                    ///////////////////////////////////
                    // Paint letter
                    ///////////////////////////////////
